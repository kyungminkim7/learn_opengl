/// Follows "Light casters" lesson.
/// Implements light attenuation and cutoffs to simulate a flashlight.
#include <iostream>
#include <memory>
#include <vector>
...
int main() {
    ...
    auto window = gl::createWindow(800, 600, "Lesson 11 - Light Casters");
    ...
    gl::ShaderProgram objectShader(srcDir + "lesson11_object.vert",
                                   srcDir + "lesson11_object.frag");

    gl::ShaderProgram lampShader(srcDir + "lesson11_lamp.vert",
                                 srcDir + "lesson11_lamp.frag");
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        objectShader.setUniform("light.position", cam->getPosition())
                .setUniform("light.direction", cam->getLookAtDirection())
                .setUniform("light.innerCutOff", std::cos(glm::radians(12.5f)))
                .setUniform("light.outerCutoff", std::cos(glm::radians(17.5f)))
                ...
                .setUniform("light.quadratic", 0.032f);
