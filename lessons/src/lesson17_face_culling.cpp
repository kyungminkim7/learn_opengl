...
int main() {
    ...
    auto window = gl::createWindow(800, 600, "Lesson 17 - Face Culling");
    ...
    gl::ShaderProgram shader(srcDir + "lesson17_face_culling.vert",
                             srcDir + "lesson17_face_culling.frag");
