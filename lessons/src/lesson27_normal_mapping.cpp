/// Follows "Normal Mapping" lesson.
/// Adds realistic lighting using normal mapping.
...
int main() {
    ...
    auto window = gl::createWindow(800, 600, "Lesson 27 - Normal Mapping");
...

    {
        ...
        gl::ShaderProgram defaultShader(srcDir + "lesson27_default.vert",
                                        srcDir + "lesson27_default.frag");
        ...
        auto diffuseMap = loadTexture(baseDir + "images/brickwall.jpg");
        auto normalMap = loadTexture(baseDir + "images/brickwall_normal.jpg");
        gl::Model wallModel;
        ...
        while (!glfwWindowShouldClose(window)) {
            ...
            wallModel.rotate(glm::radians(25.0f) * std::chrono::duration<float>(updateDuration).count(),
                             {1.0f, 0.0f, 1.0f});
